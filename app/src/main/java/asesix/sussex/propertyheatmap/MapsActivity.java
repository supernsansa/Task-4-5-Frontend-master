    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(getIntent().getExtras() !=null) {
           String locationId = getIntent().getStringExtra("id");
            ...
            if(lat!=null) {
                london = new LatLng(Double.parseDouble(lat), Double.parseDouble(lon));
                mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(london, 12.0f));
            }
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                customSharedPreferences=new CustomSharedPreferences(MapsActivity.this);
                customSharedPreferences.setStringValue("lat" , String.valueOf(point.latitude));
                customSharedPreferences.setStringValue("lon" , String.valueOf(point.longitude));
                        ...
                        try {
                            ...
                            builder.setMessage(price + "\n" + numberOfProperties)
                                ...
                                public void onClick(DialogInterface dialog,int id) {
                                    ...
                                    saveLocation(customSharedPreferences.getStringValue("userId"),customSharedPreferences.getStringValue("lat"),
                                            customSharedPreferences.getStringValue("lon"),code,
                                            avgPrice);
...
//    }
    ...
    public  void saveLocation(String userId, String lat, String lon,String postCode, String avgPrice) {
        ...
        // passing data from our text fields to our modal class.
        FavouriteLocationPOJO saveLocationPoJo = new FavouriteLocationPOJO(userId,lat,lon,postCode,avgPrice);
